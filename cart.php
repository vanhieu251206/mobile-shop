            ...
            <tbody class="align-middle">
              <tr>
                <td class="align-middle">
                  <img src="img/ss1.jpg" alt="" style="width: 50px" />
                  Product Name
                </td>
              ...
              <tr>
                <td class="align-middle">
                  <img src="img/ip2.jpg" alt="" style="width: 50px" />
                  Product Name
                </td>
                <td class="align-middle">$150</td>
                <td class="align-middle">
              ...
              <tr>
                <td class="align-middle">
                  <img src="img/ip5.jpg" alt="" style="width: 50px" />
                  Product Name
                </td>
                <td class="align-middle">$150</td>
                <td class="align-middle">
              ...
              <tr>
                <td class="align-middle">
                  <img src="img/ss6.jpg" alt="" style="width: 50px" />
                  Product Name
                </td>
                <td class="align-middle">$150</td>
                <td class="align-middle">
              ...
              <tr>
                <td class="align-middle">
                  <img src="img/ip7.jpg" alt="" style="width: 50px" />
                  Product Name
                </td>
                <td class="align-middle">$150</td>
                <td class="align-middle">
      ...
      <div class="row px-xl-5">
        ...
        <div class="col-lg-8 mb-5">
          <div class="bg-light p-30 mb-4">
            <h5 class="section-title position-relative text-uppercase mb-3">
              <span class="bg-secondary pr-3">Bộ lọc doanh thu</span>
            </h5>

            <form method="GET" action="revenue_report.php">
              <div class="form-group row">
                <label class="col-sm-3 col-form-label">Loại báo cáo</label>
                <div class="col-sm-9">
                  <select name="filter_type" class="custom-select" required>
              ...
              <div class="form-group row">
                <label class="col-sm-3 col-form-label">Chọn thời gian</label>
                <div class="col-sm-9">
                  <input
                    type="date"
                    name="date"
          ...
          <div class="bg-light p-30 mb-5">
            <h5 class="section-title position-relative text-uppercase mb-3">
              <span class="bg-secondary pr-3">Doanh thu chi tiết</span>
            </h5>
            <div class="table-responsive">
              ...
              >
                ...
                <tbody class="align-middle">
                  ...
                  <!-- Khi có backend, sẽ hiển thị dữ liệu thật -->
                </tbody>
              </table>
            </div>
          </div>
        ...
        <div class="col-lg-4">
          <h5 class="section-title position-relative text-uppercase mb-3">
            <span class="bg-secondary pr-3">Tổng kết nhanh</span>
          </h5>
          <div class="bg-light p-30 mb-4">
            <div class="border-bottom pb-2">
              <div class="d-flex justify-content-between mb-3">
              ...
              <div class="d-flex justify-content-between">
                <h6 class="font-weight-medium">Tổng doanh thu</h6>
                <h6 class="font-weight-medium">$8,640</h6>
              </div>
            </div>
            <div class="pt-2">
              <div class="d-flex justify-content-between mt-2">
          ...
          <h5 class="section-title position-relative text-uppercase mb-3">
            <span class="bg-secondary pr-3">Top sản phẩm bán chạy</span>
          </h5>
          <div class="bg-light p-30 mb-5">
            <div class="table-responsive">
              <table
              ...
              >
                ...
                <tbody class="align-middle">
                  <tr>
                    ...
                    <td>Samsung S-25 Galaxy Ultra</td>
                    <td>155</td>
                  </tr>
                  <tr>
                    <td>2</td>
