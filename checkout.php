...
<html lang="en">
  ...
  <body>
    ...
    <!-- Form thêm/chỉnh sửa khuyến mãi Start -->
    <div class="bg-light p-30 mb-5">
      <form method="post" action="promo_save.php" enctype="multipart/form-data">
        <div class="form-group row">
          <label class="col-sm-2 col-form-label">Tiêu đề chương trình</label>
          <div class="col-sm-10">
            <input
              type="text"
              name="title"
        ...
        <div class="form-group row">
          ...
          <label class="col-sm-2 col-form-label">Hình ảnh banner</label>
          <div class="col-sm-4">
            <input type="file" name="promo_image" class="form-control-file" />
          </div>
        </div>

        <!-- Có thể thêm các trường mở rộng nếu cần -->
        <div class="form-group row">
          ...
          <label class="col-sm-2 col-form-label">Loại khuyến mãi</label>
          <div class="col-sm-4">
            <select name="promo_type" class="custom-select">
        ...
        <div class="form-group row">
          <label class="col-sm-2 col-form-label">Điều kiện áp dụng</label>
          <div class="col-sm-10">
            <input
              type="text"
              name="condition"
              class="form-control"
              placeholder="Ví dụ: Áp dụng khi mua trên $100"
            />
          </div>
        </div>

        <div class="text-right">
          <button type="submit" name="save_promo" class="btn btn-primary px-5">
            Lưu chương trình
          </button>
        </div>
      </form>
    </div>
    <!-- Form thêm/chỉnh sửa khuyến mãi End -->
        ...
        <div class="col-12">
          <h5 class="section-title position-relative text-uppercase mb-3">
            <span class="bg-secondary pr-3"
              >Danh sách chương trình khuyến mãi</span
            >
          </h5>
          <div class="bg-light p-30 mb-5">
            <div class="table-responsive">
              <table class="table table-bordered table-hover text-center mb-0">
                ...
                <tbody>
                  <!-- Ví dụ dòng chương trình khuyến mãi -->
                  <tr>
                    <td>1</td>
                  ...
                  <tr>
                    <td>2</td>
                    <td>Tặng quà khi mua trên $100</td>
                    <td>15/11/2025 – 30/11/2025</td>
                    <td>
